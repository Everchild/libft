...
#    Updated: 2017/05/14 19:50:14 by sbrochar         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
pf_get_type2.c pf_get_type3.c pf_get_type4.c \
pf_apply_opt2.c pf_apply_opt3.c get_conversion.c \
\
...
ft_toupper.c get_next_line.c ft_wstrlen.c \
buff_handler.c ft_itoa_base.c ft_strupper.c ft_strjoinf.c ft_wctombc.c
